  ...
  return(
    <header className="flex shrink-0 items-center justify-between gap-2">
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="flex items-center text-lg sm:text-xl md:text-2xl font-semibold truncate">{title}</div>
      </div>
      <div className="flex items-center pointer-events-auto gap-2 shrink-0">
        <NavActions />
      </div>
    </header>
  )
